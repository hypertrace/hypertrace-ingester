 ...
 */
public class ErrorTelemetryAttributeUtils {

  private static final String OTEL_EXCEPTION_TYPE = OTelErrorAttributes.EXCEPTION_TYPE.getValue();
  private static final String OTEL_EXCEPTION_MESSAGE = OTelErrorAttributes.EXCEPTION_MESSAGE.getValue();
  private static final String OTEL_EXCEPTION_STACK_TRACE = OTelErrorAttributes.EXCEPTION_STACKTRACE.getValue();
