plugins {
  ...
  id("org.hypertrace.docker-java-application-plugin") version "0.9.1-SNAPSHOT" apply false
  id("org.hypertrace.docker-publish-plugin") version "0.9.1-SNAPSHOT" apply false
