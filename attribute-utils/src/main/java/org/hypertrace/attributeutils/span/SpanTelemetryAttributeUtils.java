package org.hypertrace.attributeutils.span;
 ...
 */
public class SpanTelemetryAttributeUtils {

  private static final String OTEL_NET_PEER_IP = OTelSpanAttributes.NET_PEER_IP.getValue();
  private static final String OTEL_NET_PEER_PORT = OTelSpanAttributes.NET_PEER_PORT.getValue();
  private static final String OTEL_NET_PEER_NAME = OTelSpanAttributes.NET_PEER_NAME.getValue();
