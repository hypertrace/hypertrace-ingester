...
dependencies {
  ...
  api("org.hypertrace.entity.service:entity-type-service-rx-client:0.7.1-SNAPSHOT")
  api("org.hypertrace.entity.service:entity-data-service-rx-client:0.7.1-SNAPSHOT")
