...
public class AbstractAttributeEnricherTest {
  ...
  protected static final BoundaryTypeValue UNKNOWN =
  ...
  Event createMockEnvoyEvent(String operationName) {
    ...
    if (operationName != null) {
      addAttributeToEvent(
          e,
          Constants.getRawSpanConstant(Envoy.ENVOY_OPERATION_NAME),
  ...
  Event.Builder createOpenSourceSpan(
      String tenantId, String eventId, String serviceName, String spanType) {
    Map<String, String> enrichedAttr =
        Map.of(
  ...
  protected StructuredTrace getBigTrace() {
    ...
    entrySpanProxyMap.put(
        Constants.getRawSpanConstant(Docker.DOCKER_CONTAINER_ID),
