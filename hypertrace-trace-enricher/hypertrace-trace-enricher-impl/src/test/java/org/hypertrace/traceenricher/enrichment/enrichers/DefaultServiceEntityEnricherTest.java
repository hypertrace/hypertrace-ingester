...
public class DefaultServiceEntityEnricherTest extends AbstractAttributeEnricherTest {
  ...
  @Test
  public void
      test_case1_findServiceNameOfFirstAncestorThatIsNotAnExitSpanAndBelongsToADifferentService() {
    ...
    Event current =
        createEvent(
            ...
            ByteBuffer.wrap("parent".getBytes()),
            "redis");
  ...
  @Test
  public void
      test_case2_findServiceNameOfFirstAncestorThatIsNotAnExitSpanAndBelongsToADifferentService() {
  ...
  @Test
  public void
      test_case3_findServiceNameOfFirstAncestorThatIsNotAnExitSpanAndBelongsToADifferentService() {
    ...
    Event current =
        createEvent(
            ...
            ByteBuffer.wrap("parent2".getBytes()),
            "redis");
  ...
  @Test
  public void
      test_case4_findServiceNameOfFirstAncestorThatIsNotAnExitSpanAndBelongsToADifferentService() {
  ...
  @Test
  public void
      test_case5_findServiceNameOfFirstAncestorThatIsNotAnExitSpanAndBelongsToADifferentService() {
  ...
  @Test
  public void
      test_case6_findServiceNameOfFirstAncestorThatIsNotAnExitSpanAndBelongsToADifferentService() {
