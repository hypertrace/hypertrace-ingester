...
import static org.hypertrace.traceenricher.util.Constants.getRawSpanConstant;
...
public class SpanTagResolver {
  ...
  private static final String OC_SPAN_KIND = getRawSpanConstant(OCAttribute.OC_ATTRIBUTE_SPAN_KIND);
  private static final String OC_SPAN_KIND_SERVER_VALUE = getRawSpanConstant(OCSpanKind.OC_SPAN_KIND_SERVER);
  private static final String OC_SPAN_KIND_CLIENT_VALUE = getRawSpanConstant(OCSpanKind.OC_SPAN_KIND_CLIENT);
  // Spans that are generated by Go Opencensus grpc/http clients have this attribute.
  private static final String OC_CLIENT_KEY = getRawSpanConstant(OCAttribute.OC_ATTRIBUTE_CLIENT_KEY);

  // todo: can't find any envoy related attributes in OTEL
  private static final String envoyOperationNameAttr = getValue(Envoy.ENVOY_OPERATION_NAME);
  private static final String envoyIngressSpanValue = getValue(Envoy.ENVOY_INGRESS_SPAN);
  private static final String envoyEgressSpanValue = getValue(Envoy.ENVOY_EGRESS_SPAN);
