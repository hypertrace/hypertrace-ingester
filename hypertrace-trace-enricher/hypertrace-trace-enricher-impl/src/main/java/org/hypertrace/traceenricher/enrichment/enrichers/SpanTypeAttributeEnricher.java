...
public class SpanTypeAttributeEnricher extends AbstractTraceEnricher {
  ...
  private static final String OTEL_SPAN_KIND = OTelSpanSemanticConventions.SPAN_KIND.getValue();
  private static final String OTEL_SPAN_KIND_SERVER_VALUE =
      OTelSpanSemanticConventions.SPAN_KIND_SERVER_VALUE.getValue();
  private static final String OTEL_SPAN_KIND_CLIENT_CLIENT =
  ...
  static final String SERVER_VALUE = Constants.getRawSpanConstant(OCSpanKind.OC_SPAN_KIND_SERVER);
  ...
  private static final Map<String, Protocol> NAME_TO_PROTOCOL_MAP =
      Map.of(
  ...
  private final String envoyOperationNameAttr =
      RawSpanConstants.getValue(Envoy.ENVOY_OPERATION_NAME);
  ...
  public static Protocol getGrpcProtocol(Event event) {
    ...
    AttributeValue componentAttrValue =
        attributeMap.get(RawSpanConstants.getValue(OTSpanTag.OT_SPAN_TAG_COMPONENT));
