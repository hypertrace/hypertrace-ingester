...
public class SpanTypeAttributeEnricher extends AbstractTraceEnricher {
  ...
  private static final String OTEL_SPAN_KIND = OTelSpanAttributes.SPAN_KIND.getValue();
  private static final String OTEL_SPAN_KIND_SERVER_VALUE = OTelSpanAttributes.SPAN_KIND_SERVER_VALUE.getValue();
  private static final String OTEL_SPAN_KIND_CLIENT_CLIENT = OTelSpanAttributes.SPAN_KIND_CLIENT_VALUE.getValue();
